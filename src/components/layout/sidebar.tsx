  ...
  return (
    <aside className="w-[280px] h-screen bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="p-3">
        <button
          onClick={onNewChat}
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 text-sm text-gray-700 hover:bg-[#fce4f0] hover:border-[#e0007a]/30 transition-colors"
        >
          <PlusIcon size={16} />
          New Chat
        </button>
